...
def run(Obj1, Obj2):
    ...
    voxel_size=2 # the fpfh is very sensitive to this parameter! larger is better

    # Extract features
    A_xyz = pcd2xyz(Obj1.pcd) # np array of size 3 by N
    B_xyz = pcd2xyz(Obj2.pcd) # np array of size 3 by N

    # extract FPFH features
    A_feats = extract_fpfh(Obj1.pcd, voxel_size=voxel_size)
    B_feats = extract_fpfh(Obj2.pcd, voxel_size=voxel_size)
    ...
    icp_sol = o3d.pipelines.registration.registration_icp(
        Obj1.pcd, Obj2.pcd, NOISE_BOUND, T_teaser,
